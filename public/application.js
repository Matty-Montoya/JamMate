...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://jammate.herokuapp.com/',
...
var instrumentEvents = __webpack_require__(15);
...
var onClearInstruments = function onClearInstruments(event) {
  event.preventDefault();
  ui.clearInstrumentSuccess();
};

var onCreateInstrument = function onCreateInstrument(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.createInstrument(data).then(ui.createInstrumentSuccess).then(function () {
    return onGetMyInstruments(event);
  });
};

var onGetAllArtists = function onGetAllArtists(event) {
  event.preventDefault();
  api.getAllInstruments().then(ui.getAllArtistsSuccess);
};

var onGetMyInstruments = function onGetMyInstruments(event) {
  event.preventDefault();
  api.getMyInstruments().then(ui.getMyInstrumentSuccess).then(ui.getInstrumentStatus);
};

var onUpdateInstrument = function onUpdateInstrument(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  var instrumentId = $(event.target).closest('div').attr('data-id');
  api.updateInstrument(data, instrumentId).then(ui.updateInstrumentSuccess).then(function () {
    return onGetMyInstruments(event);
  });
};

var onDestroyInstrument = function onDestroyInstrument(event) {
  event.preventDefault();
  var instrumentId = $(event.target).closest('button').attr('data-id');
  api.destroyInstrument(instrumentId).then(ui.deleteInstrumentSuccess).then(function () {
    return onGetMyInstruments(event);
  });
};
...
module.exports = {
  addHandlers: addHandlers,
  onGetMyInstruments: onGetMyInstruments,
  onClearInstruments: onClearInstruments,
  onCreateInstrument: onCreateInstrument,
  onGetAllArtists: onGetAllArtists
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var getAllInstruments = function getAllInstruments() {
  return $.ajax({
...
var getMyInstruments = function getMyInstruments() {
  return $.ajax({
...
var createInstrument = function createInstrument(data) {
  return $.ajax({
    url: config.apiUrl + '/instruments',
    method: 'POST',
    headers: {
...
var updateInstrument = function updateInstrument(data, instrumentId) {
  return $.ajax({
...
var destroyInstrument = function destroyInstrument(instrumentId) {
  return $.ajax({
    url: config.apiUrl + '/instruments/' + instrumentId,
    method: 'DELETE',
    headers: {
...
module.exports = {
  ...
  destroyInstrument: destroyInstrument
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var showInstrumentTemplate = __webpack_require__(18);
var showArtistTemplate = __webpack_require__(35);

var getMyInstrumentSuccess = function getMyInstrumentSuccess(data) {
  var showInstrumentHTML = showInstrumentTemplate({ instruments: data.user.instruments });
...
var getInstrumentStatus = function getInstrumentStatus(data) {
  $('.status').text('Successfully loaded your instruments!');
};

var getAllArtistsSuccess = function getAllArtistsSuccess(data) {
  var showArtistHTML = showArtistTemplate({ instruments: data.instruments });
...
var clearInstrumentSuccess = function clearInstrumentSuccess(data) {
  $('.content').empty();
...
var createInstrumentSuccess = function createInstrumentSuccess(data) {
  $('input[type=text]').val('');
...
var updateInstrumentSuccess = function updateInstrumentSuccess() {
  $('input[type=text]').val('');
...
var deleteInstrumentSuccess = function deleteInstrumentSuccess() {
...
module.exports = {
  getAllArtistsSuccess: getAllArtistsSuccess,
  getMyInstrumentSuccess: getMyInstrumentSuccess,
  clearInstrumentSuccess: clearInstrumentSuccess,
  createInstrumentSuccess: createInstrumentSuccess,
  updateInstrumentSuccess: updateInstrumentSuccess,
  deleteInstrumentSuccess: deleteInstrumentSuccess,
  getInstrumentStatus: getInstrumentStatus
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n <!-- Developers, why are we using data-id and not just id? -->\n <div>\n   <div>\n    <h3 data-id=\""
    ...
    + "\" ></h3>\n    <h4>Instrument: "
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.instrument : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </h4>\n    <h4>Genre: "
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.genre : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(8, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "    </h4>\n    <input type=\"button\" class=\"btn classic\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" data-toggle=\"modal\" data-target=\"#updateModal\" name=\"Update\" id=\"update-id\" value=\"Update\">\n\n    <!--Begin Update Modal -->\n    <div class=\"modal\" id=\"updateModal\"  tabindex=\"-1\" role=\"dialog\">\n      <div class=\"modal-dialog\" role=\"document\">\n        <div class=\"modal-content\">\n          <div class=\"modal-header\">\n            <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n            <h4 class=\"modal-title\">Update Instrument</h4>\n          </div>\n        <div class=\"modal-body\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n          <form class=\"update-instrument\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n            <!-- <p>Instrument: <input required type=\"text\" name=\"instrument[instrument]\" placeholder=\"New Instrument Name\"></p> -->\n            <p>Genre: <input required type=\"text\" name=\"instrument[genre]\" placeholder=\"New Genre Type\"> </p>\n            <input type=\"submit\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" name=\"submit\" value=\"Update Instrument\">\n          </form>\n        </div>\n      <div class=\"modal-footer\">\n        <!-- <input type=\"submit\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" name=\"update\" value=\"Update Instrument\"> -->\n      </div>\n    </div>\n  </div>\n</div>\n<!--End of Update Modal   -->\n    <button type=\"button\" class=\"btn classic destroy-id\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
  ...
  return "\n      "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.instrument : stack1), depth0))
    + "\n";
},"4":function(container,depth0,helpers,partials,data) {
    return "      No Instrument Provided.\n";
  ...
  return "<h1 style=\"text-align:center\">My Instruments </h1>\n<hr>\n\n"
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<h1 style=\"text-align:center\">All Artists</h1>\n<hr>\n\n\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.instruments : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
